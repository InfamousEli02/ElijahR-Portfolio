  ...
  return (
    <section className="projects">
      ...
      <div className="project-container">
        ...
        <div className="project-card">
          <div className="image">
            <img src="\images\KnightsofJS_Screenshot.PNG" width="100" height="100" alt="A screenshot of the Knights of JavaScript page" />
          </div>
          <div className="project-text">
        ...
        <div className="project-card">
          <div className="image">
            <img src="\images\IntrotoPrisma_Screenshot.PNG" width="100" height="100" alt="A screenshot of the Intro to Prisma Assignment" />
          </div>
          <div className="project-text">
